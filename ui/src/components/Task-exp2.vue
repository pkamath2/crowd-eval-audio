...
<template>
  <div class="row animatedsound-container">
    ...
    <div class="step-content row">
      ...
      <div>&nbsp;</div>
      <div>
        Click on the button below to listen to the arrangement to answer steps 4
        &amp; 5.
      </div>
    </div>
    ...
    <div class="step-content row">
      ...
      <div>&nbsp;</div>
      <div>
        <button id="arrangementBtn" @click="listenArrangement($event)">
    ...
    <div class="step-content row">
      ...
      <div>&nbsp;</div>
      <div>
        <span style="font-weight: bold">Adjust Ordering Step</span>: Please redo
        from Step 2 if the arrangement does not sound to be in some order of
        sequence.
      </div>
    </div>
    <div>&nbsp;</div>
    <div class="step-content">
      ...
      <div>
        ...
        <label for="ordering_checkbox">
          &nbsp;I have listened to all the audio samples and verified that the
          arrangement is in the correct order of sequence.</label
        ><br />
      </div>
    </div>
    ...
    <div class="step-content row">
      ...
      <div>
        ...
        adjust the sliders for each audio clip in Step 2 inline with the
        distance of each clip from each other.
      </div>
    </div>
    <div>&nbsp;</div>
    <div class="step-content">
      ...
      <div>
        <input
          ...
          value="distance_ordered"
          @change="update_checkbox($event)"
          disabled
        />
        <label for="distance_checkbox">
          &nbsp;I have listened to all the audio samples and verified that the
          ordering and spacing of the samples is correct.</label
        ><br />
      </div>
    </div>
    <div>&nbsp;</div>
...
export default {
  ...
  methods: {
    ...
    listenArrangement(e) {
      ...
      this.listenedCheck("full_arrangement_listened");
      this.playSequence();
    },
    validateForm() {
      ...
      const full_arrangement_listened = this.formData.full_arrangement_listened;
