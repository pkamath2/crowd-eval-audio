    ...
    <div>
      ...
      <p>
        ...
        <span style="font-family: Tahoma, Geneva, sans-serif"
          ...
          clips under test belong to the domain of audio textures (for e.g. a
          series of popping sounds, the ticking sound made by a Geiger counter
          or the sound made by water filling a container) or pitches made by
          musical instruments. The specific goal of this project is to ensure
          that the synthetic outputs generated by these deep learning models are
          validated by human beings to test for certain sound qualities like
    ...
    <ol>
      ...
      <li>
        <span style="font-family: Tahoma, Geneva, sans-serif"
          ...
          via&nbsp;Amazon's Mechanical Turk website. You understand that future
          studies will be subject to an Institutional Review Board's
          approval.&nbsp;<span lang="EN-US">  </span
        ></span>
      </li>
    </ol>
  </div>
