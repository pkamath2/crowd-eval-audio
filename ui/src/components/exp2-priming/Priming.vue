...
<template>
  <div class="row animatedsound-container-priming">
    ...
    <div id="all-inputs-priming" class="invisible" style="max-height: 10px">
      <!-- <div id="all-inputs"> -->
      <div id="ref-1-surrounding-priming" class="dotted-border-priming">
        <div
          style="
            --colorbg: grey;
            padding: 5px;
        ...
        >
          <audio
            id="ref_1_audio_priming"
            controls
            controlsList="nodownload noplaybackrate"
            @ended="
              listenedCheck('ref_1_listened_priming');
              removeSpotlight($event, 'ref-1-surrounding-priming');
            "
            @play="
              playCheck($event);
      ...
      <div>&nbsp;</div>
      <div id="clip-1-surrounding-priming" class="dotted-border-priming">
        <div
          style="
            --colorbg: #cd2026;
            padding: 5px;
      ...
      <div>&nbsp;</div>
      <div id="clip-2-surrounding-priming" class="dotted-border">
        <div
          style="
            --colorbg: #4aa564;
            padding: 5px;
      ...
      <div>&nbsp;</div>
      <div id="clip-3-surrounding-priming" class="dotted-border-priming">
        <div
          style="
            --colorbg: #f9c642;
            padding: 5px;
      ...
      <div>&nbsp;</div>
      <div id="clip-4-surrounding-priming" class="dotted-border-priming">
        <div
          style="
            --colorbg: #0071bc;
            padding: 5px;
      ...
      <div>&nbsp;</div>
      <div id="clip-5-surrounding-priming" class="dotted-border-priming">
        <div
          style="
            --colorbg: darkorange;
            padding: 5px;
      ...
      <div id="ref-2-surrounding-priming" class="dotted-border-priming">
        <div
          style="
            --colorbg: grey;
            padding: 5px;
        ...
        >
          <audio
            id="ref_2_audio_priming"
            controls
            controlsList="nodownload noplaybackrate"
            @ended="
              listenedCheck('ref_2_listened_priming');
              removeSpotlight($event, 'ref-2-surrounding-priming');
            "
            @play="
              playCheck($event);
    ...
    <div id="samples-container-priming">
      <div>&nbsp;</div>

      <div class="wrap" role="group">
        <input
          id="ref_1_value_priming"
          name="ref_1_value_priming"
          type="range"
          min="0"
          value="0"
          max="100"
        ...
        <input
          id="clip_1_value_priming"
          name="clip_1_value_priming"
          type="range"
          min="0"
          value="45"
          max="100"
        ...
        />
        <input
          id="clip_2_value_priming"
          name="clip_2_value_priming"
          type="range"
          min="0"
          value="47"
          max="100"
        ...
        />
        <input
          id="clip_3_value_priming"
          name="clip_3_value_priming"
          type="range"
          min="0"
          value="49"
          max="100"
        ...
        />
        <input
          id="clip_4_value_priming"
          name="clip_4_value_priming"
          type="range"
          min="0"
          value="51"
          max="100"
        ...
        />
        <input
          id="clip_5_value_priming"
          name="clip_5_value_priming"
          type="range"
          min="0"
          value="53"
          max="100"
    ...
    <div class="step-content-priming">
      ...
      <div>
        <input
          type="checkbox"
          id="ordering_checkbox_priming"
          name="ordering_checkbox_priming"
          value="ordered_priming"
    ...
    <div class="step-content-priming">
      ...
      <div> 
        <input
          ...
          name="distance_checkbox_priming"
          value="distance_priming"
          @change="update_checkbox($event)"
          disabled
        />
        <label for="distance_checkbox_priming">
  ...
  methods: {
    ...
    playSequence() {
      if (this.sound_index == this.sounds_in_sequence.length) {
        ...
        arrangementBtn_ordering_priming.removeAttribute("disabled");
        if (this.current_playing_arrangement.includes("ordering"))
          ordering_checkbox_priming.removeAttribute("disabled");
        if (this.current_playing_arrangement.includes("distance"))
          distance_checkbox_priming.removeAttribute("disabled");
    ...
    listenArrangement(e, nm) {
      ...
      arrangementBtn_ordering_priming.disabled = true;
      this.sounds_in_sequence = [];
      this.sound_index = 0;
      let arrangement = {
        ref_1: -1,
        clip_1: parseInt(document.getElementById("clip_1_value_priming").value),
        clip_2: parseInt(document.getElementById("clip_2_value_priming").value),
        clip_3: parseInt(document.getElementById("clip_3_value_priming").value),
        clip_4: parseInt(document.getElementById("clip_4_value_priming").value),
        clip_5: parseInt(document.getElementById("clip_5_value_priming").value),
        ref_2: 10000,
      };
    ...
    validateForm() {
      const ref_1_listened = this.formData.ref_1_listened_priming;
      const ref_2_listened = this.formData.ref_2_listened_priming;
      const clip_1_listened = this.formData.clip_1_listened_priming;
      const clip_2_listened = this.formData.clip_2_listened_priming;
      const clip_3_listened = this.formData.clip_3_listened_priming;
      const clip_4_listened = this.formData.clip_4_listened_priming;
      const clip_5_listened = this.formData.clip_5_listened_priming;
      const full_arrangement_listened =
        this.formData.ordering_arrangement_listened_priming &&
        this.formData.distance_arrangement_listened_priming;
      ...
      const clip_1_slider_changed = this.formData.clip_1_slider_changed_priming;
      const clip_2_slider_changed = this.formData.clip_2_slider_changed_priming;
      const clip_3_slider_changed = this.formData.clip_3_slider_changed_priming;
      const clip_4_slider_changed = this.formData.clip_4_slider_changed_priming;
      const clip_5_slider_changed = this.formData.clip_5_slider_changed_priming;
