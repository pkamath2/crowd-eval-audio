...
<template>
  <div class="row animatedsound-container">
    ...
    <div class="heading row">
      <div class="col-3">&nbsp;</div>
      <div class="col-7 text-center">3. Audio Perceptual Ordering Task</div>
      <div class="col-2">&nbsp;</div>
    </div>
    <div>&nbsp;</div>
    ...
    <div class="step-content row">
      ...
      <div>
        ...
        arrangement sound to be in a certain order/seqeuence <span style="font-weight: bold; text-decoration: underline">overall</span>? If not, please redo
        from Step 1.
      </div>
    </div>
    <div>&nbsp;</div>
    ...
    <div class="step-content row">
      ...
      <div>
        ...
        distance/spacing <span style="font-weight: bold; text-decoration: underline">relative</span> to its neighbor? If not, please redo from Step
        1.
      </div>
    </div>
    <div>&nbsp;</div>
